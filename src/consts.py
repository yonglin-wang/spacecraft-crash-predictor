...
COL_PATHS = OrderedDict([
                         ...
                         ('seq_label', 'seq_label.npy'),  # sequential truth label (n_sample, sampling_rate)
                         ('episode_id', 'episode_id.npy')   # int episode ids for splitting by episodes
                         ]
                        )

INDS_PATH = {"train": "train_inds.npy", "test": "test_inds.npy"}

# lists of initial feature columns generated by generate_feature_files, key names spelled same as COL_PATHS keys
INIT_FEATURES = {"velocity", "velocity_cal", "position", "joystick", "trial_key", "start_seconds", "end_seconds",
                 "label", "person", "seq_label", "episode_id"}
...
# name for .log file
EXTRACT_LOG_NAME = "feature_extraction"
...
EXP_COL_CONV = OrderedDict([('exp_ID', 'experiment ID'),
                            ...
                            ('total_sample_size', 'total CV samples'),
                            ('crash_sample_size', 'crash CV sample size'),
                            ('noncrash_sample_size', 'noncrash CV sample size'),
                            ('early_stop', 'early stopping'),
                            ('conv_crit', 'convergence criteria'),
                            ('using_seq_label', 'using sequential labels'),
