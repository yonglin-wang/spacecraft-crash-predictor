...
def eval_and_save(model, begin,
    ...
    eval_res = model.evaluate(X_test, y_test, return_dict=True, verbose=int(verbose))
...
argparser.add_argument(
    '--cal_vel', action='store_true',
    help='whether to use calculated velocity instead of original')
argparser.add_argument(
...
eval_and_save(model, begin, test_inds,
              threshold=args.threshold,
              history=history,
              verbose=not args.silent,
              save_pred_df=args.save_output)
